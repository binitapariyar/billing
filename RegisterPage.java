...
public class RegisterPage extends JFrame {
    ...
    public RegisterPage() {
        setTitle("Register - Online Billing");
        setSize(400, 350);
    ...
    private void registerUser() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/electricity_billing", "root", "")) {
            ...
            try (PreparedStatement checkStmt = conn.prepareStatement("SELECT * FROM login WHERE username = ?")) {
            ...
            // Insert user data
            try (PreparedStatement insertStmt = conn.prepareStatement("INSERT INTO login (username, password, role) VALUES (?, ?, 'Customer')")) {
